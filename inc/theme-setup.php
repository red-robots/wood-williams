...
function acstarter_widgets_init() {
  register_sidebar( array(
    ...
    register_sidebar( array(
    'name'          => esc_html__( 'Quick Search Home', 'acstarter' ),
    'id'            => 'quick-search',
    'description'   => '',
    'before_widget' => '<section id="%1$s" class="widget %2$s">',
    'after_widget'  => '</section>',
    ...
    register_sidebar( array(
    'name'          => esc_html__( 'Listings Page', 'acstarter' ),
    'id'            => 'listings',
    'description'   => '',
    'before_widget' => '<section id="%1$s" class="widget %2$s">',
    'after_widget'  => '</section>',
    ...
    register_sidebar( array(
    'name'          => esc_html__( 'Property Search Page', 'acstarter' ),
    'id'            => 'property-search',
    'description'   => '',
    'before_widget' => '<section id="%1$s" class="widget %2$s">',
    'after_widget'  => '</section>',
    ...
    register_sidebar( array(
    'name'          => esc_html__( 'Home Featured Listings', 'acstarter' ),
    ...
    register_sidebar( array(
    'name'          => esc_html__( 'Property Alerts', 'acstarter' ),
    'id'            => 'property-alerts',
    'description'   => '',
    'before_widget' => '<section id="%1$s" class="widget %2$s">',
    'after_widget'  => '</section>',
